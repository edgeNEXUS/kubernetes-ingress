...
var virtualserversResource = schema.GroupVersionResource{Group: "k8s.edgenexus.io", Version: "v1", Resource: "virtualservers"}

var virtualserversKind = schema.GroupVersionKind{Group: "k8s.edgenexus.io", Version: "v1", Kind: "VirtualServer"}
