...
var policiesResource = schema.GroupVersionResource{Group: "k8s.edgenexus.io", Version: "v1", Resource: "policies"}

var policiesKind = schema.GroupVersionKind{Group: "k8s.edgenexus.io", Version: "v1", Kind: "Policy"}
