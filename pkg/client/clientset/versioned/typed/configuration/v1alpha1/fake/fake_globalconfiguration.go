...
var globalconfigurationsResource = schema.GroupVersionResource{Group: "k8s.edgenexus.io", Version: "v1alpha1", Resource: "globalconfigurations"}

var globalconfigurationsKind = schema.GroupVersionKind{Group: "k8s.edgenexus.io", Version: "v1alpha1", Kind: "GlobalConfiguration"}
