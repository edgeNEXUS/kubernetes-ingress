...
var transportserversResource = schema.GroupVersionResource{Group: "k8s.edgenexus.io", Version: "v1alpha1", Resource: "transportservers"}

var transportserversKind = schema.GroupVersionKind{Group: "k8s.edgenexus.io", Version: "v1alpha1", Kind: "TransportServer"}
