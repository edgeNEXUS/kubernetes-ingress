...
const (
	...
	StateValid = "Valid"
	// StateInvalid is used when the resource failed validation or Edgenexus failed to reload the corresponding config.
...
// AddHeader defines an HTTP Header with an optional Always field to use with the add_header Edgenexus directive.
