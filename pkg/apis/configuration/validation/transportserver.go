...
import (
	...
	"github.com/edgeNEXUS/kubernetes-ingress/pkg/apis/configuration/v1alpha1"
...
func validateLoadBalancingMethod(method string, fieldPath *field.Path, isPlus bool) field.ErrorList {
	...
	validMethodValues := edgeStreamLoadBalanceValidInput
	if isPlus {
		validMethodValues = edgePlusStreamLoadBalanceValidInput
	}
...
var edgeStreamLoadBalanceValidInput = map[string]bool{
	"round_robin":           true,
	"least_conn":            true,
	"random":                true,
	"random two":            true,
...
var edgePlusStreamLoadBalanceValidInput = map[string]bool{
	"round_robin":                   true,
	"least_conn":                    true,
	"random":                        true,
	"random two":                    true,
