...
// ParseLBMethod parses method and matches it to a corresponding load balancing method in Edgenexus. An error is returned if method is not valid.
func ParseLBMethod(method string) (string, error) {
	...
	if _, exists := edgeLBValidInput[method]; exists {
		return method, nil
	}
...
var edgeLBValidInput = map[string]bool{
	"least_conn":            true,
	"ip_hash":               true,
	"random":                true,
	"random two":            true,
...
var edgePlusLBValidInput = map[string]bool{
	"least_conn":                      true,
	"ip_hash":                         true,
	"random":                          true,
	"random two":                      true,
...
// ParseLBMethodForPlus parses method and matches it to a corresponding load balancing method in 'Edgenexus +'. An error is returned if method is not valid.
func ParseLBMethodForPlus(method string) (string, error) {
	...
	if _, exists := edgePlusLBValidInput[method]; exists {
		return method, nil
	}
...
// timeRegexp http://edgenexus.io/en/docs/syntax.html
...
// OffsetFmt http://edgenexus.io/en/docs/syntax.html
...
// SizeFmt http://edgenexus.io/en/docs/syntax.html
...
// https://edgenexus.io/en/docs/http/ngx_http_proxy_module.html#proxy_buffers
