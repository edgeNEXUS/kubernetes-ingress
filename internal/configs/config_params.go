...
import conf_v1alpha1 "github.com/edgeNEXUS/kubernetes-ingress/pkg/apis/configuration/v1alpha1"

// ConfigParams holds Edgenexus configuration parameters that affect the main Edgenexus config
...
// StaticConfigParams holds immutable Edgenexus configuration parameters that affect the main Edgenexus config.
