...
func (*FakeManager) Version() string {
	glog.V(3).Info("Printing EdgeNEXUS Manager version")
	return "fake version"
}
...
func (*FakeManager) Reload(isEndpointsUpdate bool) error {
	glog.V(3).Infof("Reloading EdgeNEXUS Manager")
	return nil
}
...
//func (*FakeManager) SetPlusClients(plusClient *client.EdgeClient, plusConfigVersionCheckClient *http.Client) {
//}
