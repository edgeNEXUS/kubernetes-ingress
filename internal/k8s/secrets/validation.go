...
func ValidateJWKSecret(secret *api_v1.Secret) error {
	...
	// we don't validate the contents of secret.Data[JWTKeyKey], because invalid contents will not make 'Edgenexus +'
	// fail to reload: 'Edgenexus +' will return 500 responses for the affected URLs.
